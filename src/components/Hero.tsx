          ...
          <div className="order-1 md:order-2">
            <div className="mx-auto max-w-[34rem]">
              <div className="arch-mask relative isolate overflow-hidden border-4 border-[hsl(var(--white-hsl))] shadow-2xl">
                ...
                />
                <div className="absolute bottom-5 left-5 rounded-2xl bg-[hsl(var(--white-hsl)/0.9)] px-4 py-3 text-sm font-semibold text-[hsl(var(--dark-accent-hsl))] shadow-md backdrop-blur">
